	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<title>
					Chellow &gt; DNOs &gt;
					<xsl:value-of select="/source/rate-scripts/dno-contract/dno/@code" />
					&gt; Contracts &gt;
					<xsl:value-of select="/source/rate-scripts/dno-contract/@name" />
					&gt; Rate Scripts
				</title>
			</head>
			...
			<body>
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/reports/139/output/?dno-id={/source/rate-scripts/dno-contract/dno/@id}">
						<xsl:value-of select="/source/rate-scripts/dno-contract/dno/@code" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/reports/67/output/?dno-contract-id={/source/rate-scripts/dno-contract/@id}">
						<xsl:value-of
							select="concat('Contract ', /source/rate-scripts/dno-contract/@name)" />
					</a>
					&gt; Rate Scripts
				</p>
				<xsl:if test="//message">
