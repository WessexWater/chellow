	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<title>
					Chellow &gt; DNOs &gt;
					<xsl:value-of select="/source/rate-script/dno-contract/dno/@code" />
					&gt; Contracts &gt;
					<xsl:value-of select="/source/rate-script/dno-contract/@name" />
					&gt; Rate Scripts &gt;
			...
			<body>
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/reports/69/output/?dno-rate-script-id={/source/rate-script/dno-contract/@id}">
