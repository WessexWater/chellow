						...
						<form action="." method="post">
							<fieldset>
								...
								<fieldset>
									...
									<br />
									<xsl:value-of
										select="concat(' ', /source/supply-generation/mpan[llfc/@is-import='true']/ssc/@description)" />
									<label>
										<xsl:value-of
											select="'GSP Group '" />
										<select
									...
									<!-- 
										...
										<xsl:otherwise>
										<xsl:if
										test="/source/supply-generation/mpan[llfc/@is-import='true']/dce-service/@id = @id">
										<xsl:attribute
										name="selected" />
										</xsl:if>
										</xsl:otherwise>
