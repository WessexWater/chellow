		...
		<html>
			...
			<body>
				...
				<ul>
					...
					<li>
						<a href="http://chellow.wikispaces.com/" target="_blank">
							Docs
						</a>
					</li>
					<li>
					...
					<li>
						<a href="{/source/request/@context-path}/site-snags/">
							Site Snags
						</a>
					</li>
					<li>
					...
					<li>
						<a href="{/source/request/@context-path}/reports/153/output/">
							Admin
						</a>
					</li>
				</ul>
				...
				<ul>
					<li>
						<a href="{/source/request/@context-path}/read-types/">
							Read types
						</a>
					</li>
					<li>
						<a href="{/source/request/@context-path}/market-roles/">
							Market Roles
						</a>
					</li>
					<li>
					...
					<li>
						<a href="{/source/request/@context-path}/participants/">
							Market Participants
						</a>
					</li>
					<li>
					...
					<li>
						<a href="{/source/request/@context-path}/meter-types/">
							Meter Types
						</a>
					</li>
					<li>
						<a href="{/source/request/@context-path}/meter-payment-types/">
							Meter Payment Types
						</a>
					</li>
					...
					<li>
						<a href="{/source/request/@context-path}/gsp-groups/">
							GSP Groups
						</a>
					</li>
					<li>
