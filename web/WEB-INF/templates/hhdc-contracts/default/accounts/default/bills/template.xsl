		...
		<html>
			...
			<body>
				...
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/bills/account/hhdc-contract/@id}/">
						<xsl:value-of
							select="/source/bills/account/hhdc-contract/@name" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/bills/account/hhdc-contract/@id}/accounts/">
						<xsl:value-of select="'Accounts'" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/bills/account/hhdc-contract/@id}/accounts/{/source/bills/account/@id}/">
						<xsl:value-of
							select="/source/bills/account/@reference" />
					</a>
					&gt;
