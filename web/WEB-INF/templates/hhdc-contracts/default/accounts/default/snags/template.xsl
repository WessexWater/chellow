		...
		<html>
			<head>
				...
				<title>
					...
					<xsl:value-of select="/source/account-snags/account/hhdc-contract/@name" />
					&gt; Accounts &gt;
			...
			<body>
				...
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/account-snags/account/hhdc-contract/@id}/">
						<xsl:value-of select="/source/account-snags/account/hhdc-contract/@name" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/account-snags/account/hhdc-contract/@id}/accounts/">
						<xsl:value-of select="'Accounts'" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/hhdc-contracts/{/source/account-snags/account/hhdc-contract/@id}/accounts/{/source/account-snags/account/@id}/">
						<xsl:value-of select="/source/account-snags/account/@reference" />
					</a>
					&gt;
