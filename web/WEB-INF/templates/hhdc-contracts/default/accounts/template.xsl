		...
		<html>
			<head>
				...
				<title>
					...
					<xsl:value-of select="/source/accounts/hhdc-contract/@name" />
					&gt; Accounts
				</title>
			</head>
			<body>
				<p>
					...
					<a
						href="{/source/request/@context-path}/reports/109/output/?hhdc-contract-id={/source/accounts/hhdc-contract/@id}">
				...
				<br />
				<ul>
					<xsl:for-each select="/source/accounts/account">
						<li>
							<a href="{@id}/">
