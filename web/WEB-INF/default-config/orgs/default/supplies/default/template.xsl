		...
		<html>
			<head>
				<title>
					...
					<xsl:value-of
						select="/source/supply/organization/@name" />
					&gt; Sites &gt;
					<xsl:value-of
			...
			<body>
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/supply/organization/@id}/">
						<xsl:value-of
							select="/source/supply/organization/@name" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/supply/organization/@id}/supplies/">
