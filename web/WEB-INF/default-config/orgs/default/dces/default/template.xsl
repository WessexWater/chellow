		...
		<html>
			<head>
				<title>
					...
					<xsl:value-of
						select="/source/dce/organization/@name" />
					&gt; DCEs &gt;
			...
			<body>
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/dce/organization/@id}/">
						<xsl:value-of
							select="/source/dce/organization/@name" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/dce/organization/@id}/dces/">
