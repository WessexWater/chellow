		...
		<html>
			...
			<body>
				<p>
					...
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/supplier/organization/@id}/">
						<xsl:value-of
							select="/source/supplier/organization/@name" />
					</a>
					&gt;
					<a
						href="{/source/request/@context-path}/orgs/{/source/supplier/organization/@id}/suppliers/">
				...
				<br />
				<form method="post" action="?view=confirm-delete">
					<fieldset>
