		...
		<html>
			<head>
				<title>
					...
					<xsl:value-of select="/source/supplier/org/@name" />
					&gt; Suppliers &gt;
			...
			<body>
				<p>
					...
					<a
						href="{/source/request/@context-path}/orgs/{/source/supplier/org/@id}/reports/36/screen/output/?supplier-id={/source/supplier/@id}">
