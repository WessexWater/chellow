					...
					<table>
						...
						<xsl:for-each
							...
							<tr>
								...
								<td>
									<a
										href="{/source/request/@context-path}/orgs/{/source/invoice/batch/supplier-service/supplier/org/@id}/supplies/{mpan/supply-generation/supply/@id}/generation/{mpan/supply-generation/@id}/">
										<xsl:value-of
