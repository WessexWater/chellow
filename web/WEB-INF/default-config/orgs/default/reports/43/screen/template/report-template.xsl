		...
		<html>
			...
			<body>
				<p>
					...
					<a
						href="{/source/request/@context-path}/orgs/{/source/bill/account/supplier/org/@id}/suppliers/{/source/bill/account/supplier/@id}/accounts/{/source/bill/account/@id}/bills/{/source/bill/@id}/">
					...
					<tbody>
						<xsl:for-each select="/source/bill/invoice">
							<tr>
								<td>
									<a
										href="{/source/request/@context-path}/orgs/{/source/bill/account/supplier/org/@id}/reports/46/screen/output/?invoice-id={@id}">
