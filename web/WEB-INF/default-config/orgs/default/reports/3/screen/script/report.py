...
source.appendChild(supply.getXML(XmlTree("source").put("generations", XmlTree("mpans", XmlTree("mpanCore").put("mpanTop", XmlTree("meterTimeswitch").put("profileClass").put("llf", XmlTree("voltageLevel"))).put("supplierAccount").put("dceService", XmlTree("provider")))).put("mpanCores"), doc))
