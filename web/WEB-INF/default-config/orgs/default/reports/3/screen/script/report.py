...
source.appendChild(supply.toXml(doc, XmlTree("source").put("generations", XmlTree("mpans", XmlTree("mpanCore").put("mpanTop", XmlTree("meterTimeswitch").put("profileClass").put("llf", XmlTree("voltageLevel"))).put("supplierAccount").put("hhdcContract", XmlTree("provider")))).put("mpanCores")))
