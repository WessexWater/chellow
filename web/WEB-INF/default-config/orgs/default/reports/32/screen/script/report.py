...
for service in Hiber.session().createQuery("from DsoService service where service.provider.id = :dsoId order by service.startRateScript.startDate.date").setEntity("dso", dso).list():
