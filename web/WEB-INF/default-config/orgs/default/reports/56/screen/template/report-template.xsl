		...
		<html>
			...
			<body>
				<p>
					...
					<a
						href="{/source/request/@context-path}/orgs/{/source/contracts/org/@id}/hhdc-contracts/">
					...
					<tbody>
						<xsl:for-each
							...
							<tr>
								<td>
									<a
										href="{/source/request/@context-path}/orgs/{/source/contracts/org/@id}/reports/57/screen/output/?hhdc-contract-id={@id}">
