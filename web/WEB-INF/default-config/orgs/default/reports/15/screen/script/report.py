...
source.appendChild(supplyGeneration.getXML(XmlTree("mpans", XmlTree("mpanCore").put('mpanTop', XmlTree("meterTimeswitch").put('lineLossFactor', XmlTree('voltageLevel')).put('profileClass')).put('dceService', XmlTree("provider"))).put('supply', XmlTree('source').put('organization')).put('siteSupplyGenerations', XmlTree('site')), doc))
