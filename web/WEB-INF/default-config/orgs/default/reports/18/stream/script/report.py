...
for snagRow in snags:
    ...
    supplyElement = snagRow[2].toXml(net.sf.chellow.monad.vf.bo.XMLTree("generationLast",net.sf.chellow.monad.vf.bo.XMLTree("mpans",net.sf.chellow.monad.vf.bo.XMLTree("mpanCore",net.sf.chellow.monad.vf.bo.XMLTree("dso")))),doc)
