...
def content():
    ...
    try:
        ...
        if proxy_host is not None:
            ...
            if proxy_port is None:
                raise UserException(
                    ...
                    " is set, but the property " + PROXY_PORT_KEY + " is not.")
        ...
        yield "MPAN Core,MPAN Core No Spaces,ECOES PC,Chellow PC,ECOES MTC,Chellow MTC,ECOES LLFC,Chellow LLFC,ECOES SSC,Chellow SSC,ECOES Supplier, Chellow Supplier,ECOES DC,Chellow DC,ECOES MOP,Chellow MOP,ECOES GSP Group,Chellow GSP Group,ECOES MSN, Chellow MSN,ECOES Meter Type,Chellow Meter Type,Problem"
        ...
        for mpan_core in mpans:
            ...
            yield '\n' + ','.join(
                '"' + str(val) + '"' for val in [
                    ...
                    supplier_contract.party.participant.code, '', dc, '', mop,
                    '', supply.gsp_group.code, '', msn, '', meter_type,
