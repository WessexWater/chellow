    ...
    try:
        ...
        while not month_start > finish_date:
            ...
            for era in sess.query(Era).filter(
                    ...
                    or_(Era.finish_date == None,
                    Era.finish_date > period_start)).order_by(Era.start_date):
                ...
                ds = computer.SupplySource(sess, chunk_start, chunk_finish, forecast_date, era, True, None, caches)
