...
class Parser:
    ...
    def make_raw_bills(self):
        ...
        for vals in self.reader:
            if len(vals) == 0 or vals[0].startswith("#") or "".join(vals) == "":
                continue
            ...
            def val(title):
                ...
                try:
                    ...
                    raise BadRequest("For title " + title + " and index " + str(idx))
            ...
            bill_to = (
                validate_hh_start(date_val("Bill Period End"))
            ...
            breakdown["raw_lines"] = [self._title_line.strip(), self.last_line.strip()]
