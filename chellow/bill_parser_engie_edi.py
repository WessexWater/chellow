...
TCOD_MAP = {
    ...
    '219182': (
        'duos-availability-gbp', 'duos-availability-rate',
        'duos-availability-kva'),
    '144424': (
        'duos-excess-availability-gbp', 'duos-excess-availability-rate',
        'duos-excess-availability-kva'),
    '986159': ('duos-fixed-gbp', 'duos-fixed-rate', 'duos-fixed-days'),
    '838286': (
        'duos-reactive-gbp', 'duos-reactive-rate', 'duos-reactive-kvarh'),
    ...
    '663682': (
        'summer-weekday-gbp', 'summer-weekday-rate', 'summer-weekday-kwh'),
    '299992': (
    ...
    if code == "BCD":
        ...
        if consumption_charge_indicator == "1":
            ...
            try:
                ...
                raise BadRequest(
                    "Can't find the element code " + element_code +
                    " in the TCOD_MAP.")
...
def _get_element(elements, index, line):
    try:
        ...
        raise BadRequest(
            "The index " + str(index) + " is past the end of the elements " +
            str(elements) + " and line " + line + ".")
