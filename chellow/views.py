...
SEGMENTS = {
    ...
    'CCD2': {
        'description':
        "CONSUMPTION / CHARGE DETAILS: Consumption and charge only",
        'elements': [
            {
                'code': 'SEQA',
                'description': "First Level Sequence Number",
    ...
    'CCD3': {
        'description':
        "CONSUMPTION / CHARGE DETAILS: Consumption based charges only",
        'elements': [
            {
                'code': 'SEQA',
                'description': "First Level Sequence Number",
    ...
    'VAT': {
        ...
        'elements': [
            ...
            },
            {
                'code': 'PNDP',
                'description':
                "Percentage Qualifying for Lower / Zero VAT Rate",
                'components': [
                ...
                for i, (title, typ) in enumerate(comps):
                    ...
                    try:
                        ...
                        if typ == 'X':
                            ...
                            dstr = component
                            value = '-'.join((dstr[:2], dstr[2:4], dstr[4:]))
                        elif typ == 'time':
                            tstr = component
                            value = ':'.join((tstr[:2], tstr[2:4], tstr[4:]))
                        else:
                            raise BadRequest(
