content_xml = """<office:document-content
    ...
    <style:style
        style:name="cDateISO" style:family="table-cell"
        style:parent-style-name="Default" style:data-style-name="DateISO" />
    <style:style
        style:name="cTime" style:family="table-cell"
        style:parent-style-name="Default" style:data-style-name="Time" />
    <style:style style:name="cBool" style:family="table-cell"
        style:parent-style-name="Default" style:data-style-name="Bool" />
    <office:body>
        <office:spreadsheet>
        </office:spreadsheet>
    </office:body>
