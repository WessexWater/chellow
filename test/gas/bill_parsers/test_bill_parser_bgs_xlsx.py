    ...
    expected_bills = [
        {
            ...
            "datetime.datetime(2025, 5, 1, 0, 0), 0, 'Gas', "
            "datetime.datetime(2025, 5, 1, 0, 0), datetime.datetime(2025, "
            "5, 15, 0, 0), 0, 'kWh', 0.5311, 'p/kWh', 0.0]",
            "reads": [],
        }
    ]
    assert bills == expected_bills
    ...
    expected_bills = [
        {
            ...
            "vat_gbp": Decimal("0.00"),
            "gross_gbp": Decimal("0.00"),
            "raw_lines": "['Zorin Industries', 69389283, 86762618, 'CR584773269', "
            "'Extinct Volcano', datetime.datetime(2025, 6, 13, 0, 0), "
            "datetime.datetime(2025, 5, 1, 0, 0), 0, 'Gas', "
            "datetime.datetime(2025, 5, 1, 0, 0), datetime.datetime(2025, "
            "5, 31, 0, 0), 10, 'kWh', 0.5311, 'p/kWh', -5.0]",
            "reads": [],
        }
    ]
    assert bills == expected_bills
