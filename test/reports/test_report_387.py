...
"""
    ...
    mocker.patch("chellow.reports.report_387.open", return_value=mock_file)
    mocker.patch(
        "chellow.reports.report_387.chellow.dloads.make_names", return_value=("a", "b")
    )
    mocker.patch("chellow.reports.report_387.os.rename")
