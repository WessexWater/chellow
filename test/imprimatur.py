...
""",
    ...
    {
        'path': '/hhdc_contracts/34',
        'regexes': [
            r'HH contract\s*\[<a href="/hhdc_contracts/34/edit">edit</a>\]',
            r'<form action="/reports/81">'],
        'status_code': 200},

    {
        'name': "Check that we can see HHDC rate script okay. Contract 34.",
        'path': '/hhdc_rate_scripts/100',
...

    {
        ...
        "script okay. Contract 34.",
        'path': '/hhdc_rate_scripts/100/edit',
...
""",
...

    {
        ...
        'regexes': [
            r"/supplier_contracts/36"]},

    {
        'name': "Check that it's displayed properly",
        'path': '/supplier_contracts/36/edit',
        'regexes': [
        ...
        'status_code': 200},
    {
        ...
        'regexes': [
            ...
            r'href="/supplier_contracts/36/add_rate_script"\s*>add</a>\]'],
        'status_code': 200},

    {
        'name': "Update the associated rate script. Supplier contract 36",
        'path': '/supplier_rate_scripts/102/edit',
        'method': 'post',
        'data': {
            'start_year': "2000",
            'start_month': "01",
...
"""},
        'status_code': 303},
    {
        ...
        'path': '/supplier_rate_scripts/102',
        'regexes': [
            r'"/supplier_rate_scripts/102/edit"'],
        'status_code': 200},
    {
...
""",
        ...
        'status_code': 303},
    {
        'name': "Update the associated rate script. Supplier contract 38",
...
""",
...

    {
        ...
        'regexes': [
            r"start_year",
            r'<option value="34" selected>HH contract</option>',
            r'"imp_supplier_contract_id">\s*'
            '<option value="36" selected>Half-hourlies 2007',
    ...
    {
        'name': "Import hh data",
        'path': '/hhdc_contracts/34/hh_imports',
        'method': 'post',
        'files': {'import_file': 'test/no_hash.df2'},
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/0"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/0',
        'tries': {},
        'regexes': [
...

    {
        ...
        'status_code': 303,
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/1"]},
    {
        'path': '/hhdc_contracts/34/hh_imports/1',
        'tries': {},
    ...
    # with a gap before it.
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/3"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/3',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # This relies on the default timezone being BST },
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/4"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/4',
    ...
    # Test that 3 non-actual reads in a row generate a single snag
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/5"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/5',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
        ...
        'status_code': 200},
    {
        ...
        'regexes': [
            r'/hhdc_contracts/34/hh_imports/6'],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/6',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # Test if a CSV HH file can be imported },
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/7"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/7',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    # missing
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/8"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/8',
        'tries': {},
        'regexes': [
    ...
    # Check it gives a sensible error message if the first mpan is malformed
    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/9"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/9',
        'tries': {},
        'regexes': [
...

    {
        ...
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/10"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/10',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully\."],
        'status_code': 200},
    ...
    # Supply 1, era 1 },
    {
        ...
        'status_code': 200,
        'regexes': [
            r'<a href="/channel_snags\?hhdc_contract_id=34&amp;days_hidden=5">'
            r'Channel Snags</a>']},
        ...
        'status_code': 303},
    {
        ...
        'files': {'import_file': 'test/ftp/hh_data.df2'},
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/11"],
        'status_code': 303},
    {
        'path': '/hhdc_contracts/34/hh_imports/11',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully"],
        'status_code': 200},
    ...
    # Create a new batch
    {
        'path': '/supplier_contracts/39/add_batch',
        'method': 'post',
        'data': {
            'reference': "06-002",
        ...
        'status_code': 303},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/12"]
        },
    {
        'path': '/hhdc_contracts/34/hh_imports/12',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
            ...
            r"/users/5"]},
    {
        ...
        'path': '/channel_snags?hhdc_contract_id=34&days_hidden=5',
        ...
        'regexes': [
            ...
            r'<a href="/hhdc_contracts/34">HH contract</a>',
            r'<li>\s*'
        ...
        'status_code': 400},
    {
        ...
        'path': '/supplier_contracts/39/add_rate_script',
        'method': 'post',
        'data': {
            'start_year': "2009",
            'start_month': "08",
...
""",
        ...
        'status_code': 303},
    {
        ...
        'regexes': [
            ...
            r'Rate Scripts\s*'
            '\[<a href="/hhdc_contracts/34/add_rate_script">'
            'add</a>\]']},
            ...
            r"/supplier_contracts/39"]},
    {
        ...
        'path': '/eras/9/edit',
        'regexes': [
            r'<option value="34">HH contract</option>\s*</select>']},
    {
...
""",
            ...
            r'0.0,25.631634000000002,0.0']},
    {
        ...
        'path': '/supplier_rate_scripts/105/edit',
        'method': 'post',
        'data': {
            'delete': "Delete"},
        'status_code': 303},
...

    {
        ...
        'path': '/reports/81?hhdc_contract_id=34&months=1&end_year=2008&'
        'end_month=7',
        'status_code': 303},
    {
        'path': '/downloads',
    ...
    # Insert rate script
    {
        ...
        'data': {
            ...
            'start_minute': "00"},
        'regexes': [
            r"/dno_rate_scripts/109"],
        'status_code': 303},

    {
        'path': '/dno_rate_scripts/109',
        'status_code': 200},

    # Test bad syntax gives an error
    {
        'path': '/dno_rate_scripts/109/edit',
        'method': 'post',
        'data': {
            'start_year': "2010",
            'start_month': "05",
...

    {
        ...
        'path': '/supplier_contracts/38/edit',
        'method': 'post',
        'data': {
            'party_id': "22",  # BIZZ
            'name': "Half-hourlies 2013",
...
""",
    ...
    {
        'name': "Supplier contract 36, batch 6",
...

    {
        ...
        'path': '/hhdc_contracts/34/add_batch',
        'method': 'post',
        'data': {
            'reference': "001-7t",
    ...
    {
        'name': "Check that it's there to edit. HHDC contract 34",
        'path': '/hhdc_batches/8/edit',
        'status_code': 200},
    {
        'name': "View HHDC bill imports. Contract 34",
        'path': '/hhdc_bill_imports?hhdc_batch_id=8',
        'status_code': 200,
        'regexes': [
            r'<a href="/hhdc_batches/8">001-7t</a>']},
    {
        'name': "Try adding bills to the HHDC batch. Contract 34",
...

    {
        ...
        'path': '/mop_contracts/37/add_batch',
        'method': 'post',
        'data': {
            'reference': "99/992",
    ...
    {
        'name': "Check confirm-delete page. Contract 37",
        ...
        'status_code': 200},
    {
        ...
        'regexes': [
            ...
            r'table:number-columns-repeated="2"/>'
            r'<table:table-cell office:value="0" office:value-type="float" '
            r'table:number-columns-repeated="4"/>'
            r'<table:table-cell office:value="20.0" '
            r'office:value-type="float"/>\s*'
            r'<table:table-cell office:value="0" '
            r'office:value-type="float" table:number-columns-repeated="2"/>\s*'
        ...
        'status_code': 200},
    {
        ...
        'data': {
            ...
            'insert': "Insert"},
        'regexes': [
            r"/non_core_rate_scripts/111"],
        'status_code': 303},
    {
        'path': '/non_core_rate_scripts/111/edit?delete=Delete',
        'regexes': [
            r"Are you sure you want to delete this rate script\?"],
        'status_code': 200},
    {
        'path': '/non_core_rate_scripts/111/edit',
        'method': 'post',
        'data': {
            'delete': "Delete"},
        'status_code': 303},
    {
        'path': '/non_core_rate_scripts/111',
        'status_code': 404},
    {
        ...
        'data': {
            ...
            'insert': "Insert"},
        'regexes': [
            r"/non_core_rate_scripts/112"],
        'status_code': 303},
    {
        'path': '/non_core_rate_scripts/112/edit',
        'regexes': [
    ...
    # Supplier contract 62
    {
        ...
        'status_code': 303,
        'regexes': [
            r'/supplier_batches\?supplier_contract_id=42']},
    {
...
""", },
        ...
        'status_code': 200},
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/13"]},
    {
...
"""},
    ...
    {
        'name': "Do an 'import now'",
        'path': '/hhdc_contracts/34/auto_importer',
        'method': 'post',
        'regexes': [
            '/hhdc_contracts/34/auto_importer'],
        'status_code': 303},
    {
        ...
        'regexes': [
            r"Finished loading",
            r'<a href="/hhdc_contracts/34/auto_importer">Refresh page</a>']},
    {
        'path': '/hhdc_contracts/34',
        'regexes': [
            r"hh_data\.df2"]},
...
"""},
        ...
        'status_code': 200},
    {
        ...
        'path': '/reports/233?hhdc_contract_id=34&days_hidden=1',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {},
...

    {
        ...
        'regexes': [
            r'<tbody>\s*<tr>\s*<td>\s*'
            '<a href="/supplier_contracts/36">Half-hourlies 2007</a>'],
        'status_code': 200},
    {
    ...
    {
        'name': "View a MOP rate script. Contract 36.",
        'path': '/mop_rate_scripts/103',
        'status_code': 200,
        'regexes': [
            r'<a href="/mop_rate_scripts/103/edit">edit</a>']},
        ...
        'status_code': 303},
    {
        ...
        'tries': {'max': 20, 'period': 1},
        'regexes': [
            r"0031_FINISHED_watkinsexamplecom_supplies_duration\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0031_FINISHED_watkinsexamplecom_supplies_duration.csv',
        'regexes': [
            r'"10","2",'],
        'status_code': 200},
    {
    ...
    {
        'name': "Delete it. HHDC contract 34",
        ...
        'status_code': 303,
        'regexes': [
            '/hhdc_batches\?hhdc_contract_id=34']},
    {
        'name': "Check it's really gone. HHDC contract 34",
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0032_FINISHED_watkinsexamplecom_crc_special_events\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0032_FINISHED_watkinsexamplecom_crc_special_events.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0033_FINISHED_watkinsexamplecom_supply_virtual_bills_10\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0033_FINISHED_watkinsexamplecom_supply_virtual_bills_10.csv',
        'regexes': [
            r'Imp MPAN Core,Exp MPAN Core,Site Code,Site Name,'
            'Account,From,To,,mop-net-gbp,mop-problem,,'
            'dc-net-gbp,dc-problem,,imp-supplier-net-gbp,'
        ...
        'status_code': 303},
    {
        ...
        'tries': {'max': 20, 'period': 1},
        'regexes': [
            r"0034_FINISHED_watkinsexamplecom_bill_check\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0034_FINISHED_watkinsexamplecom_bill_check.csv',
        'regexes': [
        ...
        'status_code': 200},
    {
        ...
        'path': '/reports/87?supplier_contract_id=36&start_year=2013&'
        ...
        'status_code': 303},
    {
        ...
        'tries': {'max': 20, 'period': 1},
        'regexes': [
            r"0035_FINISHED_watkinsexamplecom_virtual_bills\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0035_FINISHED_watkinsexamplecom_virtual_bills.csv',
        'regexes': [
...

    {
        ...
        'path': '/reports/109?supplier_contract_id=36&months=1&'
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0036_FINISHED_watkinsexamplecom_displaced\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0036_FINISHED_watkinsexamplecom_displaced.csv',
        'regexes': [
    ...
    # Insert era
    {
        ...
        'status_code': 303},
    {
        'path': '/reports/233?hhdc_contract_id=34&days_hidden=0',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {},
        'regexes': [
            r"0037_FINISHED_watkinsexamplecom_channel_snags\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0037_FINISHED_watkinsexamplecom_channel_snags.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {'max': 20, 'period': 1},
        'regexes': [
            r"0038_FINISHED_watkinsexamplecom_supplies_snapshot\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0038_FINISHED_watkinsexamplecom_supplies_snapshot.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0041_FINISHED_watkinsexamplecom_supply_virtual_bills_7\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
    ...
    # Import some hh Stark DF2 data
    {
        ...
        'status_code': 303,
        'regexes': [
            r"/hhdc_contracts/34/hh_imports/14"]},
    {
        'path': '/hhdc_contracts/34/hh_imports/14',
        'tries': {},
        'regexes': [
            r"The import has completed.*successfully."],
        'status_code': 200},
    ...
    {
        'name': 'Supplier contract 39, batch 12',
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0043_FINISHED_watkinsexamplecom_bill_check\.csv"]},
    {
        'path': '/downloads/0043_FINISHED_watkinsexamplecom_bill_check.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0044_FINISHED_watkinsexamplecom_supplies_monthly_duration_for_"
            r"1_1_to_2008_7\.csv"]},
    {
        'path': '/downloads/'
        '0044_FINISHED_watkinsexamplecom_supplies_monthly_duration_for_'
        '1_1_to_2008_7.csv',
        'status_code': 200,
        'regexes': [
            r"supply-id,supply-name,source-code,generator-type,month,pc-code,"
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0045_FINISHED_watkinsexamplecom_hh_data_row_200801010000\.csv"]},
    {
        'path': '/downloads/'
        '0045_FINISHED_watkinsexamplecom_hh_data_row_200801010000.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0046_FINISHED_watkinsexamplecom_hh_data_row_201001010000\.csv"]},
    {
        'path': '/downloads/'
        '0046_FINISHED_watkinsexamplecom_hh_data_row_201001010000.csv',
        'status_code': 200,
        'regexes': [
    ...
    # Add in second batch
    {
        ...
        'status_code': 303},
    {
        'path': '/hhdc_batches?hhdc_contract_id=34',
        'status_code': 200,
        'regexes': [
            r'<a\s*href="/hhdc_contracts/34"\s*>HH contract</a>',
            r'<tr>\s*<td>\s*'
    ...
    # Add in second batch
    {
        ...
        'status_code': 303},
    {
        'path': '/mop_batches?mop_contract_id=37',
        'status_code': 200,
        'regexes': [
            r'<tr>\s*<td>\s*'
    ...
    {
        'path': '/downloads/'
        '0047_FINISHED_watkinsexamplecom_bill_check.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0048_FINISHED_watkinsexamplecom_bill_check\.csv"]},
    {
        'path': '/downloads/0048_FINISHED_watkinsexamplecom_bill_check.csv',
        'status_code': 200,
        'regexes': [
    ...
    {
        'path': '/downloads/0049_FINISHED_watkinsexamplecom_bill_check.csv',
        'status_code': 200,
        'regexes': [
            r'07-002,3423760010,N,10,9.07,0.21,2012-01-05 00:00,'
            '2012-01-10 23:30,22 1065 3921 534,CI017,Roselands,'
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0050_FINISHED_watkinsexamplecom_crc_2009_2010_supply_10\.csv"]},
    {
        'path': '/downloads/'
        '0050_FINISHED_watkinsexamplecom_crc_2009_2010_supply_10.csv',
        'status_code': 200,
        'regexes': [
...
""", },
...

    {
        ...
        'path': '/reports/247?site_id=1&scenario_id=43&compression=False',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {},
        'status_code': 200,
        'regexes': [
            r"0051_FINISHED_watkinsexamplecom_scenario_bau_20150601_0000_for_"
            r"1_months_site_CI004\.ods"]},
    {
        'path': '/downloads/'
        '0051_FINISHED_watkinsexamplecom_scenario_bau_20150601_0000_for_'
...

    {
        ...
        'path': '/reports/247?site_id=3&scenario_id=43&compression=False',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {'max': 30, 'period': 1},
        'status_code': 200,
        'regexes': [
            r"0052_FINISHED_watkinsexamplecom_scenario_bau_20150601_0000_for_"
            r"1_months_site_CI005\.ods"]},
    {
        'path': '/downloads/'
        '0052_FINISHED_watkinsexamplecom_scenario_bau_20150601_0000_for_'
...
"""},
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0053_FINISHED_watkinsexamplecom_scenario_bsuos_20110101_0000_"
            r"for_1_months_site_CI005\.ods"]},
    {
        'path': '/downloads/'
        '0053_FINISHED_watkinsexamplecom_scenario_bsuos_20110101_0000_for_'
        '1_months_site_CI005.ods',
        'status_code': 200,
        'regexes': [
            r'<table:table-row>\s*'
...
""", },
    ...
    # Run scenario for a site
    {
        'path': '/reports/247?site_id=1&scenario_id=45&compression=False',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {'max': 30, 'period': 1},
        'status_code': 200,
        'regexes': [
            r'0054_FINISHED_watkinsexamplecom_scenario_used_20110101_0000_for_'
            r'1_months_site_CI004\.ods']},
    {
        'path': '/downloads/'
        '0054_FINISHED_watkinsexamplecom_scenario_used_20110101_0000_for_'
        '1_months_site_CI004.ods',
        'status_code': 200,
        'regexes': [
            r'<table:table-row>\s*'
...

    {
        ...
        'path': '/supplier_contracts/44/edit',
        'method': 'post',
        'data': {
            'party_id': "90",  # COOP
            'name': "scenario_bsuos",
...
"""},
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0055_FINISHED_watkinsexamplecom_scenario_bsuos_50110101_0000_"
            r"for_1_months_site_CI005\.ods"]},
    {
        'path': '/downloads/'
        '0055_FINISHED_watkinsexamplecom_scenario_bsuos_50110101_0000_'
...
""",
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0056_FINISHED_watkinsexamplecom_supply_virtual_bills_16\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0056_FINISHED_watkinsexamplecom_supply_virtual_bills_16.csv',
        'regexes': [
            r'Imp MPAN Core,Exp MPAN Core,Site Code,Site Name,'],
        'status_code': 200},
...
""", },
...

    {
        ...
        'path': '/reports/247?site_id=5&scenario_id=46&compression=False',
        'status_code': 303},
    {
        'path': '/downloads',
        'tries': {'max': 30, 'period': 1},
        'status_code': 200,
        'regexes': [
            r"0057_FINISHED_watkinsexamplecom_scenario_leap_day_20160201_0000_"
            r"for_1_months_site_CH023\.ods"]},
    {
        'path': '/downloads/'
        '0057_FINISHED_watkinsexamplecom_scenario_leap_day_20160201_0000_'
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0058_FINISHED_watkinsexamplecom_supplies_hh_data_200808012330_"
            r"filter\.csv"]},
    {
        'path': '/downloads/'
        '0058_FINISHED_watkinsexamplecom_supplies_hh_data_200808012330_'
        'filter.csv',
        'status_code': 200,
        ...
        'regexes': [
            ...
            r'filename="0058_FINISHED_watkinsexamplecom_supplies_hh_data_'
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0059_FINISHED_watkinsexamplecom_crc_2005_2006_supply_2\.csv"]},
    {
        'path': '/downloads/'
        '0059_FINISHED_watkinsexamplecom_crc_2005_2006_supply_2.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0060_FINISHED_watkinsexamplecom_crc_2008_2009_supply_7\.csv"]},
    {
        'path': '/downloads/'
        '0060_FINISHED_watkinsexamplecom_crc_2008_2009_supply_7.csv',
        'status_code': 200,
        'regexes': [
...

    {
        ...
        'path': '/reports/231?mop_contract_id=37&start_year=2015&'
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r'0061_FINISHED_watkinsexamplecom_mop_virtual_bills\.csv']},
    {
        'path': '/downloads/'
        '0061_FINISHED_watkinsexamplecom_mop_virtual_bills.csv',
        'status_code': 200,
        'regexes': [
            r'Import MPAN Core,Export MPAN Core,Start Date,Finish Date,'
            r'net-gbp,problem',
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0062_FINISHED_watkinsexamplecom_supply_virtual_bills_5\.csv"],
        'status_code': 200},
    {
        'name': "Check supplies snapshot at beginning of supply",
        'path': '/downloads/'
        '0062_FINISHED_watkinsexamplecom_supply_virtual_bills_5.csv',
        'regexes': [
            r'22 0883 6932 301,,CI005,Wheal Rodney,4341,'
...
"""}},
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0063_FINISHED_watkinsexamplecom_supply_virtual_bills_5\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0063_FINISHED_watkinsexamplecom_supply_virtual_bills_5.csv',
        'regexes': [
            r'22 0883 6932 301,,CI005,Wheal Rodney,4341,'
            r'2014-06-04 00:00,2014-06-04 23:30,,0,,,0,,,'
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0064_FINISHED_watkinsexamplecom_crc_2011_2012_supply_10\.csv"],
        'status_code': 200},
    {
        'name': "CRC report for mismatched TPRs",
        'path': '/downloads/'
        '0064_FINISHED_watkinsexamplecom_crc_2011_2012_supply_10.csv',
        'tries': {},
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0065_FINISHED_watkinsexamplecom_crc_2010_2011_supply_10\.csv"],
        'status_code': 200},
    {
        'name': "CRC meter change reads",
        'path': '/downloads/'
        '0065_FINISHED_watkinsexamplecom_crc_2010_2011_supply_10.csv',
        'status_code': 200,
        'regexes': [
            r'73142.39335486847']},
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0066_FINISHED_watkinsexamplecom_supplies_duration\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0066_FINISHED_watkinsexamplecom_supplies_duration.csv',
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0067_FINISHED_watkinsexamplecom_bill_check\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0067_FINISHED_watkinsexamplecom_bill_check.csv',
        'regexes': [
            r'07-002,3423760010,N,10,9.07,0.21,2012-01-05 00:00,'
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0069_FINISHED_watkinsexamplecom_supplies_duration\.csv"],
        'status_code': 200},
    {
        'name': "Supplies duration normal reads with prev, pres the same.",
        'path': '/downloads/'
        '0069_FINISHED_watkinsexamplecom_supplies_duration.csv',
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r'0070_FINISHED_watkinsexamplecom_monthly_duration_20030801_0000_'
            r'for_1_months_site_CI005\.ods'],
        'status_code': 200},
    {
        'name': "Eras starting after report period.",
        'path': '/downloads/'
        '0070_FINISHED_watkinsexamplecom_monthly_duration_20030801_0000_'
        'for_1_months_site_CI005.ods',
        'regexes': [
            r'<table:table-row>\s*'
            r'<table:table-cell table:number-columns-repeated="2"/>\s*'
...

    {
        ...
        'path': '/reports/109?supplier_contract_id=38&months=1&'
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0071_FINISHED_watkinsexamplecom_displaced\.csv"]},
    {
        'path': '/downloads/0071_FINISHED_watkinsexamplecom_displaced.csv',
        'status_code': 200,
        'regexes': [
        ...
        'status_code': 303},
    {
        ...
        'status_code': 200,
        'regexes': [
            r"0072_FINISHED_watkinsexamplecom_monthly_"
            r"duration_20150201_0000_for_1_months_site_CH023\.ods"]
        },

    {
        'path': '/downloads/'
        '0072_FINISHED_watkinsexamplecom_monthly_'
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0073_FINISHED_watkinsexamplecom_crc_2010_2011_supply_10\.csv"],
        'status_code': 200},
    {
        'name': "CRC meter change reads",
        'path': '/downloads/'
        '0073_FINISHED_watkinsexamplecom_crc_2010_2011_supply_10.csv',
        'status_code': 200,
        'regexes': [
            r'73142.39335486847']},
        ...
        'status_code': 303},
    {
        ...
        'tries': {'max': 20, 'period': 1},
        'regexes': [
            r'0075_FINISHED_watkinsexamplecom_monthly_'
            r'duration_20141201_0000_for_1_months_supply_16\.ods'],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0075_FINISHED_watkinsexamplecom_monthly_'
...
""",
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0076_FINISHED_watkinsexamplecom_supply_virtual_bills_16\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0076_FINISHED_watkinsexamplecom_supply_virtual_bills_16.csv',
        'regexes': [
            r'Imp MPAN Core,Exp MPAN Core,Site Code,Site Name,'],
        'status_code': 200},
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0082_FINISHED_watkinsexamplecom_supply_virtual_bills_5\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0082_FINISHED_watkinsexamplecom_supply_virtual_bills_5.csv',
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r"0083_FINISHED_watkinsexamplecom_supply_virtual_bills_10\.csv"],
        'status_code': 200},
    {
        'path': '/downloads/'
        '0083_FINISHED_watkinsexamplecom_supply_virtual_bills_10.csv',
        'regexes': [
            r'3409.15883838'],
        'status_code': 200},
        ...
        'status_code': 303},
    {
        ...
        'tries': {},
        'regexes': [
            r'0084_FINISHED_watkinsexamplecom_monthly_duration_20051101_0000_'
            r'for_1_months_site_CI005\.ods'],
        'status_code': 200},
    {
        'name': "Test displaced virtual bill with generation",
        'path': '/downloads/'
        '0084_FINISHED_watkinsexamplecom_monthly_duration_20051101_0000_for_1_'
...
"""},
    ...
    {
        'name': "Supplier contract 36, batch 4",
...
""", },
        ...
        'status_code': 400},
    {
        ...
        'path': '/hhdc_contracts/35/add_rate_script',
        'status_code': 200},
    {
