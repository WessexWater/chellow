...
""",
            ...
            r'<input type="hidden" name="mop_batch_id" value="9">']},
    {
        ...
        'regexes': [
            r'<input type="submit" name="delete" value="Delete">']},
    {
        'name': "Check we can see it in 'view' mode. Contract 36",
        'path': '/mop_batches/9',
        'status_code': 200},
...
"""},
        ...
        'status_code': 200},
    {
        ...
        'regexes': [
            ...
            r'25964,'
            r'7830.0,1.00941,1.00941,HCUF \| M3,M3,1 \| 2.8317,1.0,9001802,'
            r'310621.0456747202,'
            r'0.019448,0.019548,17872.26,6072.0202008495735,'
            r'11800.239799150426,,67.8,157.8,67.8,90.00000000000001,24025.32,'
