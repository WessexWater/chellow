...
def test_duos_vb_unmetered(sess):
    ...
    dno_party.insert_contract(sess, dno_party.dno_code, "", {}, vf, None, dno_rates)
    ...
    assert ds.hh_data == [
        {
            ...
            "duos-green": {"gbp": 0.0, "kwh": 0, "rate": {0.72}},
            "exp-msp-kvar": 0,
            "exp-msp-kvarh": 0,
            "gsp-kw": 0.0,
            "gsp-kwh": 0.0,
...
def test_SiteSource(sess):
    ...
    dno_party.insert_contract(
        sess, dno_party.dno_code, "", {}, valid_from, None, dno_rates
    )
