...
from chellow.models import (
    MarketRole, Participant, VoltageLevel, insert_voltage_levels
)
...
def test_parse_Line_Loss_Factor_Class(sess):
    ...
    dno = participant.insert_party(
        sess, market_role_R, 'WPD', to_utc(ct_datetime(2000, 1, 1)), None,
        '22')
    ...
    dno.insert_llfc(
        sess, llfc_code, llfc_description, voltage_level, False, True,
        to_utc(ct_datetime(1996, 1, 1)), None)
    sess.commit()
