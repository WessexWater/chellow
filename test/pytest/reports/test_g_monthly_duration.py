...
"""
    ...
    expected = [
        [
            ...
            'kwh', 'gbp', 'billed_kwh', 'billed_gbp', 'units_consumed',
            'correction_factor', 'unit_code', 'unit_factor', 'calorific_value',
            'kwh', 'gas_rate', 'gas_gbp', 'ccl_rate', 'standing_rate',
            'standing_gbp', 'net_gbp', 'vat_gbp', 'gross_gbp', 'problem'
        ],
        [
            Datetime(2020, 9, 1, 1), '87614362', 'main', 'EA1', 'hgeu8rhg',
            'M3', 'Fusion 2020', '22488', 'Water Works', '',
            Datetime(2015, 9, 30, 23, 30), 10888.888888888665,
            1146.1869155555785, 45.0, 12.4, 1000.0000000000156, 1.0, 'M3', 1.0,
            39.2, 10888.888888888665, 0.1, 1088.8888888888619, 0.00525288, 0.1,
            0.1, 1146.1869155555785, 0.0, 1146.1869155555785, None
        ]
    ]
