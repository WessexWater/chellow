...
from chellow.models import (
    GContract, GDn, GReadingFrequency, GUnit, MarketRole, Participant, Site,
...
def test_supply(mocker, sess, client):
    ...
    mocker.patch(
        'chellow.reports.report_g_supplies_snapshot.open',
    ...
    expected = [
        [
            ...
            'Other Site Names', 'MPRN', 'Exit Zone', 'Meter Serial Number',
            'Correction Factor', 'Unit', 'Contract', 'Account', 'Supply Start',
            'Supply Finish'
        ],
        [
            '2020-09-01 01:00', '22488', 'Water Works', '', '', '87614362',
            'EA1', 'hgeu8rhg', '1', 'M3', 'Fusion 2020', 'd7gthekrg',
            '2010-01-01 00:00', ''
        ]
    ]
