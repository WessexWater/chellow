...
def test_general_import_era_insert(sess):
    ...
    site.insert_e_supply(
        ...
        pc, '845', cop, None, {}, None, None, None, None, None,
        '22 7867 6232 781', '521', exp_supplier_contract, '7748', 361)

    sess.commit()

    action = 'insert'
    vals = [
        '22 7867 6232 781', '2020-10-01 00:00', '{no change}', '{no change}',
        '{no change}', '{no change}', '{no change}', '{no change}',
        '{no change}', '{no change}', '{no change}', '{no change}',
        '{no change}', '{no change}', '{no change}', '{no change}',
        '{no change}', '{no change}', '{no change}', '{no change}',
        '{no change}', '{no change}', '{no change}', '{no change}',
        'Fusion Supplier 2000', '{no change}', '{no change}', '{no change}',
        '{no change}'
    ]
    args = []
