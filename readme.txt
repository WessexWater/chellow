...
while contracts.next():
    ...
    print_line(pw, ['insert', 'hhdc-contract', contract.getParty().getParticipant().getCode(), contract.getName(), start_rate_script.getStartDate(), start_rate_script.getFinishDate(), contract.getFrequency(), contract.getLag(), contract.getChargeScript(), start_rate_script.getScript(), contract.getProperties(), contract.getState()])
